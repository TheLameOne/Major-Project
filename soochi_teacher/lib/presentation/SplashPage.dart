...
import 'package:soochi_teacher/presentation/TabPages/Calendar.dart';
import '../utils/global.dart';
import '../utils/styles.dart';
import 'TabPages/Home.dart';
import 'TabPages/More.dart';
      ...
      child: Card(
        ...
        child: Row(
          ...
          children: <Widget>[
            _getBottomBarItem(
                index: 0,
                icontab: Icons.format_align_justify_rounded,
                text: "Attendance"),
            _getBottomBarItem(
                index: 1,
                icontab: Icons.calendar_month_rounded,
                text: "Profile"),
            _getBottomBarItem(
